...
const getCustomer = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { customerId } = req.params;
    const result = yield customer_service_1.customerService.getCustomer(customerId);
    (0, sendResponse_1.sendResponse)(res, {
        status: http_status_1.default.OK,
        success: true,
